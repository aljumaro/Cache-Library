...
public class LFUCacheTest {
	...
	private LFUCache<Integer, Element> cache;
	...
	@Test
	public void testReorderMultiFrecuency() {
		// Given
		int numElements = 4;
		...
		// Then
		Assertions.assertEquals(2, cache.getFirstKey());
		Assertions.assertEquals(4, cache.getLastKey());
		...
		Assertions.assertEquals(4, cache.getFirstKey());
		Assertions.assertEquals(3, cache.getLastKey());
	}
